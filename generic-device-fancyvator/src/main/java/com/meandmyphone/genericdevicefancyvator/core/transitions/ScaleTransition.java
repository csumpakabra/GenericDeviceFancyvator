...
public class ScaleTransition extends Transition {
    ...
    public ScaleTransition(GLRenderer renderer, int cycleDuration, int nodeId, int easeType, int destroyEffect, boolean destroyOnFinsished, boolean autoreverse, float fromX, float toX, float fromY, float toY) {
        super(renderer, cycleDuration, nodeId, easeType, destroyEffect, destroyOnFinsished, autoreverse);
        this.fromX = fromX;
        this.fromY = fromY;
        this.toX = toX;
        this.toY = toY;
